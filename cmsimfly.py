...
from flask import Flask, send_from_directory, request, redirect, \
    render_template, session, make_response, url_for, flash, Blueprint, current_app
import random
import math
import os
# init.py 為自行建立的起始物件
...
cmsimfly_app = Blueprint('cmsimfly', __name__, url_prefix='/cf', template_folder='templates')
